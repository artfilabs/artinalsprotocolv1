...
//     public struct ART20V2 has drop {}
...
// public struct NFTMigratedEvent has copy, drop {
//         old_id: ID,
//         new_id: ID,
//         artinals_id: u64,
//         asset_id: u64,
...
//     fun init(witness: ART20V2, ctx: &mut TxContext) {
...
//         event::emit(NFTMigratedEvent {
//             old_id,
//             new_id: object::uid_to_inner(&new_nft.id),
//             artinals_id,
//             asset_id,
//             collection_id
//         });
...
//     // Modified batch migration entry function with vector<u8> for URLs
//     public entry fun batch_migrate_and_transfer(
//         mut nfts: vector<ID>,
//         mut artinals_ids: vector<u64>,
//         mut asset_ids: vector<u64>,
//         collection_id: ID,
//         creator: address,
//         name: vector<u8>,
//         description: vector<u8>,
//         uri_bytes: vector<u8>,      // Changed to vector<u8>
//         logo_uri_bytes: vector<u8>, // Changed to vector<u8>
//         max_supply: u64,
//         recipient: address,
//         ctx: &mut TxContext
//     ) {
...
//         // Convert bytes to String and Url
//         let name = string::utf8(name);
//         let description = string::utf8(description);
//         let uri = url::new_unsafe_from_bytes(uri_bytes);
//         let logo_uri = url::new_unsafe_from_bytes(logo_uri_bytes);
        
//         while (i < len) {
//             let old_id = vector::pop_back(&mut nfts);
//             let artinals_id = vector::pop_back(&mut artinals_ids);
//             let asset_id = vector::pop_back(&mut asset_ids);

//             let new_nft = create_new_nft(
//                 old_id,
//                 artinals_id,
//                 creator,
//                 name,
...
//         vector::destroy_empty(artinals_ids);
